...
from src.config import TARGET_COLUMN,UNWANTED_COLUMNS
import numpy as np
...
class DataValidation:
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            base_df=base_df.drop(UNWANTED_COLUMNS,axis=1)
            ...
            train_df=train_df.drop(UNWANTED_COLUMNS,axis=1)
            test_df=test_df.drop(UNWANTED_COLUMNS,axis=1)
